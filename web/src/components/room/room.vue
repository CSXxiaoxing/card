    ...
    <div id='room'>
        ...
        <header>
            ...
            <dl>
                ...
                @click='liaotian'>
                    <img src="src/img/room03.png" height="155" width="149" alt="" />
                </dt>
        ...
        <div class='roomMain'>
            <div class='left'>
                <ul>
                    <li @click='applyOn(0)'>
                        <div>
                            <img src="src/img/roomK02.png" alt="" />
                            <img src="src/img/roomPage01.png" alt="" />
                            <span>1</span>
                            <img class='leftZhuan' src="src/img/room1.png">
                            <div class='leftImg'>
                                <img src="src/img/friend1.png" alt="" />
                                <span>{{Ztype == {} ? $store.state.data.Ztype.zn_points:Ztype.zn_points}}</span>
                            </div>
                        </div>
                        <p>{{Ztype == {} ? $store.state.data.Ztype.zn_member_name:Ztype.zn_member_name}}</p>
                    </li>
            ...
            <div class='right'>
                <ul @click='speak'>
                    <li v-for='player in (roomData999[0] == "" ? $store.state.data.Room["id"] : roomData999)' v-if='fanzhuID != player.zn_member_id' :id='player.zn_member_id'>
                        <div>
                            <img src="src/img/roomK03.png" alt="" />
                            <img src="src/img/roomPage04.png" alt="" />
                            <span>6</span>
                            <div class='leftImg'>
                                <img src="src/img/friend1.png" alt="" />
            ...
            socket.on('new_msg', function (data) { 
                ...
                switch(Number(data.type)){
                    ...
                    case 13:                            // 房主开始游戏
                        ...
                        self.K ();
                        // self.gameResult(this.$store.state.idRoom.id);
                        break;
                    case 14:                            // 房主暂停游戏
                        self.host.allType = 0;
                        self.init.textStyle = 0;
